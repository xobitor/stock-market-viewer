...
import { createYahooFinanceMcpServer, } from "./server.js";
...
export function createYahooFinanceMcpWebHandler(options) {
...
export function createYahooFinanceMcpNodeHandler(options) {
    const path = options.path ?? "/mcp";
