...
import { stringifyJsonSafe, toJsonSafe } from "../lib/jsonSafe.js";
...
export function getYahooFinanceMcpToolNames() {
    return TOOL_SPECS.map((tool) => tool.name);
}
export function createYahooFinanceMcpServer(options) {
