    ...
    if (type === "result") {
        ...
        */
        if (options.logErrors === true) {
            ...
            const version = encodeURIComponent(deno_js_1.default.version);
...
Open a new issue and include the affected symbol: ${deno_js_1.default.name} v${deno_js_1.default.version}

  ${consts_js_1.repository}/issues/new?template=validation-error.yml&title=${title}&library-version=${version}
